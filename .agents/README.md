...
The [2026-09-16–17 code/dependency review](./review-2026-09-16.md) records the latest correctness findings, dependency verification, and long-list browser measurements. The [2026-09-10 product/design review](./review-2026-09-10.md) records the visual review and notebook-icon generation provenance.
